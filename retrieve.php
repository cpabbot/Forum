...
if(mysqli_num_rows($result) != 0) {
    ...
    echo "<button id='toggle-reload' onclick='window.top.location = &quot;message-board2.html&quot;'>Stop Reload</button>";
...
//Connect to Database
$mysqli = NEW MySQLi('localhost','root','','test'); //'localhost','id389750_forumuser','dev7Archers','id389750_forum'
...
if($resultSet->num_rows != 0) {
    ...
    echo "<div class='load-more'><button class='load-more'>^ Load 15 more ^</button></div><br>";
